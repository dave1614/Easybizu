        ...
        <CardBoxModal v-model="showPerformActionmModal" button="danger" buttonLabel="Close" :title="`Choose action to perform on ${selected_user.name}`">
          <table class="mt-8">
            ...
            <tbody>
              ...
              <tr class="cursor-pointer" @click="Inertia.visit(route('users_goeasy_savings_main_page', selected_user_id))">
                <td>5.</td>
      ...
      <CardBox v-if="showHistoriesModal" class="mb-6" has-table>
        ...
        <table class="mt-8">
          ...
          <tbody class="">
            ...
            <tr class="cursor-pointer" @click="Inertia.visit(route('users_earnings_wallet',selected_user_id))">
              <td>8.</td>
